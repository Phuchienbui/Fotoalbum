const images =
    [
        ...
        { src: "./imgkombri/daniil_kondrashin-autumn-9912502_1920.jpg", alt: "Frau mit roten Haaren", title: "Porträt einer Frau",liked:false },
    ...
    for (let i = 0; i < images.length; i++) {
        galleryHtML +=
            ...
            <li class="gallery_item">
                    <button onclick="clickEvents(${i})" class="gallery__button" id="Btn-${i}">
